...
class AdvancedComparisonView(ctk.CTkFrame):
    ...
    def _build_center_panel(self, parent):
        ...
        # Web編集ボタン
        ctk.CTkButton(
            web_header, text="🖊️ 編集", width=50, height=22, fg_color="#4CAF50",
        ...
        # PDF編集ボタン
        ctk.CTkButton(
            pdf_header, text="🖊️ 編集", width=50, height=22, fg_color="#2196F3",
    ...
    def _open_region_editor(self, source_type: str):
        ...
        print(f"[RegionEditor] 開く: {source_type}, 領域数: {len(regions)}")
